...
<body>
	...
	<section id="hero" class="d-flex flex-column justify-content-center">
		<div class="container" data-aos="zoom-in" data-aos-delay="100">
			<h1>Hafiizh Zoelva Khairani</h1>
			<p>I'm <span class="typed" data-typed-items="Web Developer, Web Designer"></span></p>
				...
				<div class="row">
					...
					<div class="col-lg-8 pt-4 pt-lg-0 content">
						<div class="row">
							<div class="col-lg-6">
								<ul>
									<li><i class="icofont-rounded-right"></i> <strong>Nama Lengkap:</strong> Hafiizh Zoelva Khairani</li>
									<li><i class="icofont-rounded-right"></i> <strong>Website:</strong> www.hafiizhzk.co.vu</li>
									<li><i class="icofont-rounded-right"></i> <strong>Telepon/WA:</strong> 0821 5725 4820 <a href="https://wa.me/6282157254820" class="whatsapp"><i class="bx bxl-whatsapp"></i></a></li>
									<li><i class="icofont-rounded-right"></i> <strong>Asal:</strong> Kota Martapura (Kalimantan Selatan)
									</li>
								</ul>
							</div>
							<div class="col-lg-6">
								<ul>
									<li><i class="icofont-rounded-right"></i> <strong>Umur:</strong> 20</li>
									<li><i class="icofont-rounded-right"></i> <strong>Pekerjaan:</strong> Mahasiswa</li>
								</ul>
							</div>
						</div>
						<p>
							Selamat datang di Web Personal saya, di Web ini anda dapat melihat profile, resume, portfolio, dan lain
							sebagainya tentang saya. Saya hanya seorang Beginner Web Developer yang masih banyak belajar dan juga ikut
							dalam Organisasi Kemanusiaan yaitu Indonesian Escorting Ambulance.
						</p>
					</div>
				</div>
